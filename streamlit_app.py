...
st.markdown(
    "A tiny, reproducible demo with sample data. "
    "Swap in your full dataset later."
)
...
if not DATA_PATH.exists():
    st.error(
        "Data file not found: "
        f"{DATA_PATH}. "
        "Make sure 'data/sample_results.csv' exists in the repo."
    )
    st.stop()
...
st.caption(
    "Data: tiny handcrafted sample for demo. "
    "Replace data/sample_results.csv with your full dataset to scale up."
)
